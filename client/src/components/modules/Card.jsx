...
// TODO (Step 8.3): import NewComment
...
const Card = (props) => {
  ...
  // TODO (Step 8.1): implement a callback function addNewComment that adds a 
  ...
  return (
    <div className="Card-container">
      ...
      {commentsList}
      {/* TODO (Step 8.3): add in the NewComment component (refer to Feed.jsx, line 46) */}
    </div>
  )
};
